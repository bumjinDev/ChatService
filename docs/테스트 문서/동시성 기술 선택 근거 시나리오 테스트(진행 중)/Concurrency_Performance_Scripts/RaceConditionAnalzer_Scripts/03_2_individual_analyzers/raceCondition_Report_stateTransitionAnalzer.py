...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Rule 4: State Transition 분석 및 시각화',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
사용 예시:
  # 전체 방 분석
  python rule4_state_transition_analyzer.py --preprocessor_file data.csv --result_file result.csv --output_dir output/
  
  # 특정 방 분석  
  python rule4_state_transition_analyzer.py --room_number 1135 --preprocessor_file data.csv --result_file result.csv --output_dir output/
        """
    )
